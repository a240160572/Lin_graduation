...
if __name__ == "__main__":
    ...
    parser.add_argument('--vision',             default=0,      type=str2bool,      help='Whether to use VisionAviary (default: False)', metavar='')
    parser.add_argument('--gui',                default=1,       type=str2bool,      help='Whether to use PyBullet GUI (default: True)', metavar='')
    ...
    parser.add_argument('--obstacles',          default=0,       type=str2bool,      help='Whether to add obstacles to the environment (default: True)', metavar='')
    ...
    p.removeBody(1)
    p.DRONE_IDS = p.loadURDF("/home/lin/gym_pybullet_drones/gym_pybullet_drones/assets/cf2x.urdf",[0, 0, 1])

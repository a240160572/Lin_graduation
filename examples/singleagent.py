...
from gym_pybullet_drones.envs.single_agent_rl.PlanningAviary import PlanningAviary
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env',        default='planning',      type=str,             choices=['takeoff', 'hover', 'flythrugate', 'tune'], help='Task (default: hover)', metavar='')
    ...
    if ARGS.obs == ObservationType.KIN: 
        ...
        if env_name == "planning-aviary-v0": 
            eval_env = make_vec_env(PlanningAviary,
                                    env_kwargs=sa_env_kwargs,
                                    n_envs=1,
                                    seed=0
                                    )
